<?php
    ...
    class ModuleTest extends BaseTest
    {
        ...
        public function testGetModuleObjects()
        {
            ...
            $this->assertTrue (array_key_exists('contracts', $modules));
            ...
            $this->assertTrue ($modules['contractss']  instanceof Module);
            ...
            $this->assertTrue ($modules['contracts']->canDisable());
        }
        ...
        public function testGetModuleNameAndDisplayName()
        {
            ...
            $this->assertEquals('Contracts', $modules['contracts']::getModuleLabelByTypeAndLanguage('Plural'));
        }
