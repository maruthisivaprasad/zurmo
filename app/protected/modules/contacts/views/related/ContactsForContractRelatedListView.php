<?php
    ...
    class ContactsForContractRelatedListView extends ContactsRelatedListView
    {
        /**
        ...
        public static function getDefaultMetadata()
        {
            ...
            $metadata['global']['toolbar']['elements'][] =
                                ...
                                //currently it will not work correctly since in the db it would store a static value instead of it still being dynamic
                                    ...
                                    'htmlOptions' => array( 'id' => 'SelectContactsForContractFromRelatedListLink',
        ...
        {
            return Zurmo::t('ContactsModule', 'ContactsModulePluralLabel For ContractsModuleSingularLabel',
