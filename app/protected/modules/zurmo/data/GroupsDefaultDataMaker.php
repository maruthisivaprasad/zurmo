<?php
    ...
    class GroupsDefaultDataMaker extends DefaultDataMaker
    {
        public function make()
        {
            ...
            $everyone->setRight('ContractsModule', ContractsModule::RIGHT_ACCESS_CONTRACTS, Right::ALLOW);
            $everyone->setRight('ContractsModule', ContractsModule::RIGHT_CREATE_CONTRACTS, Right::ALLOW);
            $everyone->setRight('ContractsModule', ContractsModule::RIGHT_DELETE_CONTRACTS, Right::ALLOW);
