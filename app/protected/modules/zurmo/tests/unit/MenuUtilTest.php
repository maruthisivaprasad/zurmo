<?php
    ...
    class MenuUtilTest extends ZurmoBaseTest
    {
        ...
        public function testGetAccessibleShortcutsCreateMenuByCurrentUser()
        {
            ...
            $bill->setRight('ContractsModule', ContractsModule::RIGHT_ACCESS_CONTRACTS);
            $bill->setRight('ContractsModule', ContractsModule::RIGHT_CREATE_CONTRACTS);
            $saved = $bill->save();
            $this->assertTrue($saved);
            ...
            $compareData = array(
                ...
                'items' => array(
                        ...
                        array(
                            ...
                            'right'  => ContractsModule::RIGHT_CREATE_CONTRACTS,
                            'mobile' => true,
                        ),
                        array(
                            'label'  => 'Report',
