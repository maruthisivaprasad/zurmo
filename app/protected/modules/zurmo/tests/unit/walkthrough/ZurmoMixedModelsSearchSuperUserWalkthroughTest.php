<?php
    ...
    class ZurmoMixedModelsSearchSuperUserWalkthroughTest extends ZurmoWalkthroughBaseTest
    {
        ...
        public function testSuperUserGlobalList()
        {
            ...
            $this->assertContains('<div class="cgrid-view type-contracts" id="list-view-contracts">', $content);
            ...
            $this->assertNotContains('id="ContractsForMixedModelsSearchListView">', $content);
