<?php
    ...
    class ModelAutoCompleteUtilTest extends ZurmoBaseTest
    {
        ...
        public function testGetGlobalSearchResultsByPartialTermWithRegularUserAndElevationStepsForRegularUser()
        {
            ...
            $this->assertEquals(Right::DENY, $jimmy->getEffectiveRight('ContractsModule', ContractsModule::RIGHT_ACCESS_CONTRACTS));
            ...
            $jimmy->setRight   ('ContractsModule', ContractsModule::RIGHT_ACCESS_CONTRACTS);
