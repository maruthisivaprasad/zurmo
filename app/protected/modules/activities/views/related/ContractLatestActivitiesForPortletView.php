<?php
    ...
    /**
     * Wrapper view for displaying an Contract's latest activities feed.
     */
    class ContractLatestActivitiesForPortletView extends LatestActivitiesForPortletView
    {
                            ...
                            array('type'                   => 'CreateConversationFromRelatedListLink',
                                  'routeParameters'         =>
                                    array('relationAttributeName'    => 'notUsed',
                                            'relationModelClassName' => 'Contract',
        ...
        {
            return 'LatestActivitiesForContractListView';
        }
