...
<table border="1" style="border-collapse:collapse;" cellpadding="0" cellspacing="1">
    <tbody>
        ...
        <tr>
            <td>Door Fee</td>
            <td><?php echo $data['door_fee'];?></td>
            <td style="padding-left:30px">Total Key Monies</td>
            <td style="padding-left:20px"><?php echo $data['total_key'];?></td>
        </tr>
        <tr><td colspan="4"><h3>Video</h3></td></tr>
        <tr>
            <td>Bulk Services</td>
            <td><?php echo $data['video_bulk_services'];?></td>
            <td style="padding-left:30px">Bulk Cost Base</td>
            <td style="padding-left:20px"><?php echo $data['video_bulk_cost'];?></td>
        </tr>
        <tr>
            <td>Bulk MRR</td>
