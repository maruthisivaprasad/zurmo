<?php
     ...
     ********************************************************************************/
    /**
     * Contract details overlay view in Contract task kanban view
     */
    class ContractDetailsOverlayView extends TaskRelatedDetailsOverlayView
    {
        ...
        protected function renderAmountContent()
        {
            ...
            $content = ZurmoHtml::tag('p', array('class' => static::DESCRIPTION_CLASS),
                                      Zurmo::t('ContractsModule', 'Amount') .
