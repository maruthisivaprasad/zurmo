<?php
    ...
    class User extends Permitable
    {
        ...
        protected static function compareWithCurrentPasswordHash($password, User $user)
        {
            ...
            $databaseHash           = $user->hash ; if ( strlen($databaseHash) === 32 && md5($password) === $databaseHash ) { $user->hash = $databaseHash = $phpassHashObject->hashPassword($user->hash);unset($user->originalAttributeValues['hash']); }
