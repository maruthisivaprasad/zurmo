<?php
    ...
    /**
     * The portlet view for contract detail view
     */
    class ContractDetailsPortletView extends ContractEditAndDetailsView implements PortletViewInterface
    {
        protected $params;
        protected $viewData;
        ...
        {
            return 'ContractEditAndDetailsView';
        }
