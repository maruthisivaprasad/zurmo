                        ...
                        array(
                            'rows' => array(
                               ...
                               array(
                                ...
                                array(
                                    'type' => 'ContractLatestActivitiesForPortlet',
                                ),
                            )
                        ),
                        array(
                            'rows' => array(
                                array(
                                     'type' => 'UpcomingMeetingsForContractCalendar',
                                    ),
                                array(
                                     'type' => 'OpenTasksForContractRelatedList',
                                    ),
                                array(
                                     'type' => 'ContactsForContractRelatedList',
                                    )
                            )
                        )
                    )
