<?php
    ...
    /**
     * Renders an action bar specifically for the Contracts search and listview.
     */
    class ContractsSecuredActionBarForSearchAndListView extends SecuredActionBarForSearchAndListView
    {
