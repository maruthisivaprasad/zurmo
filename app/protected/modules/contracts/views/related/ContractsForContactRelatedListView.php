<?php
    ...
    class ContractsForContactRelatedListView extends ContractsRelatedListView
    {
            /**
        ...
        public static function getDefaultMetadata()
        {
            ...
            $metadata['global']['toolbar']['elements'][] =
                                ...
                                //currently it will not work correctly since in the db it would store a static value instead of it still being dynamic
                                    ...
                                    'htmlOptions' => array( 'id'   => 'SelectContractsForContactFromRelatedListLink',
        ...
        {
            return Zurmo::t('ContractsModule', 'ContractsModulePluralLabel For ContactsModuleSingularLabel',
                        LabelUtil::getTranslationParamsForAllModules());
        }

        protected static function resolveAjaxOptionsForSelectList()
        {
            $title = Zurmo::t('ContractsModule', 'ContractsModuleSingularLabel Search',
                            LabelUtil::getTranslationParamsForAllModules());
