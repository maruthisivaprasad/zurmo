<?php
    ...
    /**
     * A chart view for displaying a chart showing all Contracts by source.
     *
     */
    class ContractsBySourceChartView extends ChartView implements PortletViewInterface
    {
        public function renderContent()
        {
            $accessContent = $this->resolveContentIfCurrentUserCanAccessChartByModule(
                                        'ContractsModule', 'ContractsModulePluralLabel');
        ...
        public static function getDefaultMetadata()
        {
            return array(
                'perUser' => array(
                    'title' => "eval:Zurmo::t('ContractsModule', 'Contracts By Lead Source', LabelUtil::getTranslationParamsForAllModules())",
