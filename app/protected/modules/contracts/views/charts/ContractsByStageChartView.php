<?php
    ...
    /**
     * A chart view for displaying a chart showing all Contracts by sales stage.
     *
     */
    class ContractsByStageChartView extends ChartView implements PortletViewInterface
    {
        ...
        public static function getDefaultMetadata()
        {
            return array(
                'perUser' => array(
                    'title' => "eval:Zurmo::t('ContractsModule', 'Contracts By Sales Stage', LabelUtil::getTranslationParamsForAllModules())",
