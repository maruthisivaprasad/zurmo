<?php
    ...
    /**
     * Build a data set showing Contracts grouped by the source summed by the amount.
     */
    class ContractsBySourceChartDataProvider extends ChartDataProvider
    {
        ...
        public function getChartData()
        {
            $customFieldData = CustomFieldDataModelUtil::
                               getDataByModelClassNameAndAttributeName('Contract', 'source');
