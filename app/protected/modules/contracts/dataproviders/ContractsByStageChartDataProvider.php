<?php
    ...
    /**
     * Build a data set showing Contracts grouped by the stage summed by the amount.
     */
    class ContractsByStageChartDataProvider extends ChartDataProvider
    {
        protected $model;

        public function __construct()
        {
            $this->model = new Contract(false);
        }
        ...
        public function getChartData()
        {
            $customFieldData = CustomFieldDataModelUtil::
                               getDataByModelClassNameAndAttributeName('Contract', 'stage');
        ...
        protected static function makeChartSqlQuery()
        {
            ...
            Contract::resolveReadPermissionsOptimizationToSqlQuery(Yii::app()->user->userModel,
                                                                      $joinTablesAdapter,
                                                                      $where,
                                                                      $selectDistinct);
            ...
            $joinTablesAdapter->addFromTableAndGetAliasName('customfield', 'stage_customfield_id', 'contract');
            ...
            $sql                       = SQLQueryUtil::makeQuery('contract', $selectQueryAdapter,
