<?php
    ...
    class ContractImportTest extends ImportBaseTest
    {
        ...
        public function testSimpleUserImportWhereAllRowsSucceed()
        {
            ...
            createTempTableByFileNameAndTableName('importTest.csv', $import->getTempTableName(), true,
                                                  Yii::getPathOfAlias('application.modules.contracts.tests.unit.files'));
            ...
            $this->assertTrue($contracts[1]->delete());
            $this->assertTrue($contracts[2]->delete());
        }
