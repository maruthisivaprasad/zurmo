<?php
    ...
    class ContractEditAndDetailsViewTest extends ZurmoBaseTest
    {
        ...
        public function testSetAndGetMetadata()
        {
            ...
            $view = new ContractEditAndDetailsView('Details', 'whatever', 'whatever', $contract);
            $originalMetadata = ContractEditAndDetailsView::getMetadata($user);
            $metadataIn = $originalMetadata;
            $metadataIn['perUser']['junk1'] = 'stuff1';
            $metadataIn['global'] ['junk2'] = 'stuff2';
            $view->setMetadata($metadataIn, $user);
            $metadataOut = ContractEditAndDetailsView::getMetadata($user);
