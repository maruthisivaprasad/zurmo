<?php
    ...
    class ContractMappingRuleFormAndElementTypeUtilTest extends ImportBaseTest
    {
        ...
        {
            //Contract
            $attributeImportRules = new ContractAttributeImportRules(new ImportModelTestItem(), 'hasOne');
            ...
            //ContractDerived
            $attributeImportRules = new ContractDerivedAttributeImportRules(new ImportModelTestItem(), 'contractDerived');
            $collection           = MappingRuleFormAndElementTypeUtil::
                                    makeCollectionByAttributeImportRules($attributeImportRules,
                                                                         'contractDerived', 'importColumn');
            $this->assertEquals(2, count($collection));
            $this->assertEquals('ImportMappingRuleDefaultModelNameId', $collection[0]['elementType']);
