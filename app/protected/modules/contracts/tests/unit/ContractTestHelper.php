<?php
    ...
    {
        public static function createContractByNameForOwner($name, $owner)
        {
        ...
        public static function createContractWithAccountByNameForOwner($name, $owner, $account)
        {
            $currencies    = Currency::getAll();
            $currencyValue = new CurrencyValue();
            $currencyValue->value = 500.54;
        ...
        public static function createContractStagesIfDoesNotExist()
        {
        ...
        public static function createContractSourcesIfDoesNotExist()
        {
