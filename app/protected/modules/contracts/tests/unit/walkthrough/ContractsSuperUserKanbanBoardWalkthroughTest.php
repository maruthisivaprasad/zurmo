<?php
    ...
    /**
     * contracts Module Walkthrough spefically testing the kanban board list and updating the Contract sales
     * stage when you would drag a card from one column to another
     */
    class ContractsSuperUserKanbanBoardWalkthroughTest extends ZurmoWalkthroughBaseTest
    {
        ...
        public static function setUpBeforeClass()
        {
            ...
            self::$contract = ContractTestHelper::createContractWithAccountByNameForOwner('superOpp',      $super, $account);
