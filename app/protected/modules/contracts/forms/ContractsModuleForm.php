<?php
    ...
    class ContractsModuleForm extends GlobalSearchEnabledModuleForm
    {
        ...
        public function attributeLabels()
        {
            return array_merge(parent::attributeLabels(), array(
                'stageToProbabilityMapping' => Zurmo::t('ContractsModule', 'Probability Mapping'),
                'automaticProbabilityMappingDisabled' => Zurmo::t('ContractsModule', 'Disable Automatic Probability Mapping'),
            ));
        }
            ...
            foreach ($this->stageToProbabilityMapping as $probability)
            {
                if (!$validator->validateValue($probability))
                {
                    $this->addError('stageToProbabilityMapping',
                                    Zurmo::t('ContractsModule', 'Mapped Probabilities must be integers'));
                    $valid = false;
                }
            }
            return $valid;
