    ...
    class Contract extends OwnedSecurableItem implements StarredInterface
    {
        ...
        public static function translatedAttributeLabels($language)
        {
            ...
            return array_merge(parent::translatedAttributeLabels($language), array(
                ...
                'amount'      => Zurmo::t('ContractsModule', 'Amount',  array(), null, $language),
                'closeDate'   => Zurmo::t('ContractsModule', 'Close Date',  array(), null, $language),
                ...
                'probability' => Zurmo::t('ContractsModule', 'Probability',  array(), null, $language),
