<?php
    ...
    /**
     * Import rules for when an Contract is not a specific attribute on a model, but most likely a casted down
     ...
     */
    class ContractDerivedAttributeImportRules extends ModelDerivedAttributeImportRules
    {
        public static function getSanitizerUtilTypesInProcessingOrder()
        {
            return array('ContractDerivedIdValueType');
        }
    }
?>