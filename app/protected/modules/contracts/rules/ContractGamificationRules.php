<?php
    ...
    class ContractGamificationRules extends GamificationRules
    {
         ...
         * @var string
         */
        const SCORE_CATEGORY_WIN_CONTRACT = 'WinContract';

        /**
         * @var string
         */
        const SCORE_TYPE_WIN_CONTRACT     = 'WinContract';
        ...
        public function scoreOnSaveModel(CEvent $event)
        {
            ...
            if (array_key_exists('value', $event->sender->stage->originalAttributeValues) &&
                $event->sender->stage->value == Contract::getStageClosedWonValue())
            {
        ...
        /**
         * @return Point type/value data for a user changing the stage of an Contract to 'Closed Won'
         */
        public static function getPointTypesAndValuesForWinContract()
        {
